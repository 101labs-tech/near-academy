...
describe('User', () => {
  ...
  it('registration can send email', async (done) => {
    ...
    const emailMsg = {
      from: { email: 'test@test.com', name: 'NearAcademy' },
      html:
        'Please enter the following captcha <br /><img alt="captcha" src="https://near.academy/captchas/0.png" /> <br />on <a href="https://near.academy/reset-password?key=test">https://near.academy/reset-password?key=test</a>',
      subject: 'Password reset',
      text:
        'Please enter the following captcha https://near.academy/captchas/0.png on https://near.academy/reset-password?key=test',
