...
1\. Install NEAR CLI: <AnimatedCode>npm install -g near-cli </AnimatedCode> <!-- intentional trailing whitespace -->
...
4\. Now the contract name is "museum.testnet" and the method is called get_meme_count. So type: <AnimatedCode>near view museum.testnet get\_meme\_count</AnimatedCode>. This will return you the amount of memes that are registered in the museum.
